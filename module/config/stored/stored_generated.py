...
class StoredGenerated:
    StaminaJelly = StoredCounter("DataUpdate.ItemStorage.StaminaJelly")
    JuicyStaminaJelly = StoredCounter("DataUpdate.ItemStorage.JuicyStaminaJelly")
    Coin = StoredInt("DataUpdate.ItemStorage.Coin")
    Crystal = StoredInt("DataUpdate.ItemStorage.Crystal")
